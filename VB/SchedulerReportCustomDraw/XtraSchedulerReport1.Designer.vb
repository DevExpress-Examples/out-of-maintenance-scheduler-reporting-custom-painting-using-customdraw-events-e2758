...
Namespace SchedulerReportCustomDraw
	Partial Public Class XtraSchedulerReport1
		...
		Private Sub InitializeComponent()
			...
			' Detail
			' 
			Me.Detail.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() { Me.horizontalResourceHeaders1, Me.calendarControl1, Me.horizontalDateHeaders1, Me.dayViewTimeCells1})
			...
			' 
			Me.horizontalResourceHeaders1.LocationFloat = New DevExpress.Utils.PointFloat(0F, 147.5834F)
			Me.horizontalResourceHeaders1.Name = "horizontalResourceHeaders1"
			Me.horizontalResourceHeaders1.SizeF = New System.Drawing.SizeF(650F, 25F)
