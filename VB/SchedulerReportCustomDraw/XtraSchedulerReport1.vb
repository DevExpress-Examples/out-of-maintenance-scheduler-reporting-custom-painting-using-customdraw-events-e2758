...
Namespace SchedulerReportCustomDraw
	Partial Public Class XtraSchedulerReport1
		...
		Public Sub New()
			InitializeComponent()
			Me.carUsageImages = DevExpress.Utils.Controls.ImageHelper.CreateImageCollectionFromResources("car_usage_types.png", System.Reflection.Assembly.GetExecutingAssembly(), New Size(16, 16))
		...
		Private Sub dayViewTimeRuler1_CustomDrawDayViewTimeRuler(ByVal sender As Object, ByVal e As CustomDrawObjectEventArgs)
			...
			Using sf As New StringFormat()
				...
				e.Cache.DrawVString(DevExpress.XtraScheduler.Native.SchedulerTimeZoneHelper.Instance.CurrentTimeZone.DisplayName, e.Cache.GetFont(New Font(Font.FontFamily, 20, FontStyle.Bold), FontStyle.Bold), e.Cache.GetSolidBrush(Color.Gray), e.Bounds, sf, -90)
				e.Handled = True
			End Using
		End Sub
