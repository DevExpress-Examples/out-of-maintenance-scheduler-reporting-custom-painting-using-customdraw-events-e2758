...
Namespace SchedulerReportCustomDraw
    Partial Public Class XtraSchedulerReport1
        ...
        Public Sub New()
            InitializeComponent()
            Me.carUsageImages = DevExpress.Utils.Controls.ImageHelper.CreateImageCollectionFromResources("SchedulerReportCustomDraw.car_usage_types.png", System.Reflection.Assembly.GetExecutingAssembly(), New Size(16, 16))
